...
st.write('F Model 2:',f2[0][0])
st.write('F Tabel:',f_table)
...
st.write('MSE Model B1:',sse21[0][0])
st.write('F X2 setelah ditambahkan X1 pada Model B1:',f21[0][0])
st.write('F Tabel:',f_table)
...
st.write('F penambahan 3 Variabel pada Model C1:',f312[0][0])
st.write('F Tabel:',f_table)
...
st.write('F penambahan 3 Variabel pada Model C1:',f123[0][0])
st.write('F Tabel:',f_table)
...
st.write('F penambahan 3 Variabel pada Model C1:',f213[0][0])
st.write('F Tabel:',f_table)
